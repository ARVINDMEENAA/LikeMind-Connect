...
import { 
  createProfile, updateProfile, getProfile, getRecommendations, 
  getUserById, getSharedHobbies, testRecommendations, debugEmbeddings 
...
// Add multer for profile update (for file uploads and FormData)
